/**
 * Page-local authority reader for the device detail page.
 *
 * Same rationale as the list page's hook (kept separate to respect the file
 * ownership boundary between the two waves): the JWT already carries the
 * authority scope, and core/auth imports cleanly under vitest without the umi
 * runtime. TA gets the editing surface, CU the read-only subset.
 */
