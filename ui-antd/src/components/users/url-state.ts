 ...
 *
 * Shared by every host of UsersTable (the /users TA page and the SA
 * /tenants/:id/users page — the URL keys are identical, the data source is
 * injected per host). page/pageSize/sortProperty/sortOrder/textSearch live
 * in the URL; a refresh or bookmark restores them. Server pages are
 * 0-based, UI pages 1-based — the conversion happens in toPageLink(), never
 * here. pages/users/list/url-state.ts re-exports this module for its tests.
 */
